...
#TODO: environment should be local information of the maze
#TODO: should we seperate different mazes from the csv file?
#TODO: maze will be np.array -> can convert here
#TODO: I don't know what apsilon is
...
class Agent:
    ...
    def make_a_move(self, net, epsilon, device = 'cuda'):
        ...
        next_state, reward = self.env.state_update(action)
        self.total_reward += reward
        
        if self.total_reward < self.min_reward:
            self.isgameon = False # fail to solve maze
        ...
        self.buffer.push(transition) # see helper class ReplayMemory
